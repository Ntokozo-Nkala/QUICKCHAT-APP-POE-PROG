...
public class MessageTest {
    ...
    @Test
    public void testRecipientNumberSuccess() {
        Message message = new Message("1234567890", 1, "+27718693002", "Hi Mike", "");
        String expected = "Cell phone number successfully captured.";
        String actual = message.checkRecipientCell();
        assertEquals(expected, actual);
    }
    ...
    @Test
    public void testRecipientNumberFailure() {
        Message message = new Message("1234567890", 1, "0810009346", "Hi Mike", "");
        String expected = "Cell phone number incorrectly formatted or does not contain an international code. Please correct the number and try again.";
        String actual = message.checkRecipientCell();
        assertEquals(expected, actual);
    }
    ...
    @Test
    public void testMessageHashIsCorrect() {
        Message message = new Message("0000000000", 1, "+27718693002", "Hi Mike, can you join us for dinner tonight", "");
        String actualHash = message.createMessageHash();
        assertTrue(actualHash.contains(":") && actualHash.contains("HITONIGHT"));
    }
    ...
    public void testMessageIDIsCreated() {
        ...
        String actualIDMessage = message.getMessageID();
        assertTrue(actualIDMessage.contains("Message ID generated:"));
        assertTrue(actualIDMessage.contains("1234567890"));
    }
    
    @Test
    public void testMessageActionSend() {
        Message message = new Message("1234567890", 1, "+27718693002", "Hi Mike, can you join us for dinner tonight?", "");
        message.createMessageHash();
        String actual = message.sendMessage("+27718693002", "Hi Mike, can you join us for dinner tonight?", "Send");
        assertEquals("Message successfully sent.", actual);
    }
    
    @Test
    public void testMessageActionDiscard() {
        Message message = new Message("0987654321", 1, "08575975889", "Hi Keegan, did you receive the payment?", "");
        message.createMessageHash();
        String actual = message.sendMessage("08575975889", "Hi Keegan, did you receive the payment?", "Discard");
        assertEquals("Message disregarded", actual);
    }
    
    @Test
    public void testMessageActionStore() {
        Message message = new Message("5555555555", 1, "+27718693002", "Hi Mike", "");
        message.createMessageHash();
        String actual = message.sendMessage("+27718693002", "Hi Mike", "Store");
